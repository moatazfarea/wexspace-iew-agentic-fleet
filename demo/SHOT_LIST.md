...
|---|---|---|---|
| 0:00–0:15 | Live Cloud Run result | `.run` URL, `/health`, structured `/adk/live` result | immediate working proof |
...
| 3:20–3:38 | Cloud Console + logs | service, revision, project, timestamp, request log | cloud proof |
