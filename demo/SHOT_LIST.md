...
| 1:40–2:15 | `/adk/live` | Gemini 3.7 Flash and real three-agent/tool trace | mandatory tech/delegation |
| 2:15–2:40 | pause/restart/resume/review | same workflow ID through state transitions | persistence/human gate |
| 2:40–3:00 | negative tests + test suite | blocked missing input/injection/unallowlisted context; current full suite OK | robustness |
